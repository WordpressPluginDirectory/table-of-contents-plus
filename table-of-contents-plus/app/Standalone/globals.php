...
define( 'TOC_POSITION_BEFORE_FIRST_PARAGRAPH', 5 );
define( 'TOC_POSITION_AFTER_FIRST_PARAGRAPH', 6 );
...
define( 'TOC_PLUGIN_PATH', plugins_url( '', AIOSEO_TABLE_OF_CONTENTS_FILE ) );
