...
/**
 * Wraps the `aioseo_table_of_contents_migrations_log` option that tracks
 ...
 * `lastSchemaVersion === aioseoTableOfContents()->version` before the runner ever
...
class MigrationLog {
	 ...
	 * @var string
	 */
	private $optionName = 'aioseo_table_of_contents_migrations_log';
